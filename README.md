...
Taiwan.md is an open-source, curated, AI-friendly knowledge base that helps the world — and AI — truly understand Taiwan. Not a Wikipedia clone. Not a tourism guide. A **curated exhibition** of what makes Taiwan extraordinary.
...
- 📖 **62+ curated articles** across 12 categories
- 🌐 **Bilingual** — 繁體中文 (SSOT) + English (21 articles)
- 🤖 **AI-native** — [`llms.txt`](https://taiwan.md/llms.txt), [`robots.txt`](https://taiwan.md/robots.txt), structured Markdown
- 🕸️ **Interactive knowledge graph** with D3.js
...
src/
├── pages/           ← Astro pages
├── layouts/         ← Glassmorphism nav, responsive
└── content/         ← Build-time projection from knowledge/
```

**Tech:** Astro v5 + GitHub Pages + D3.js knowledge graph
...
**What makes us different:** Open source + AI-native + community-driven + curated (not encyclopedic)
...
All images sourced from [Wikimedia Commons](https://commons.wikimedia.org/) with verified CC licenses. Each image includes attribution, license type, and source link.
